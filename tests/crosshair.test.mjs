...
function codeFor(value, prefix = 'VOLLE-X1') {
...
test('export and import round-trip a normalized config without mutation', () => {
    ...
    assert.deepEqual(importCrosshairCode(codeFor(normalizeCrosshairConfig(input), 'WARRBALL-X1')), normalizeCrosshairConfig(input));
    assert.deepEqual(input, before);
});
